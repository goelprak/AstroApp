...
function App() {
  ...
  const renderTab = () => {
    ...
    switch (activeTab) {
      ...
      case 'natal': return <div className="animate-fade-up" key={k}><NatalChart birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'analysis': return <div className="animate-fade-up" key={k}><DetailedAnalysis birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} onUpdateContext={d => updateTabContext('detailed_analysis',d)} birthData={birthData} language={language} /></div>;
      case 'numerology': return <div className="animate-fade-up" key={k}><Numerology name={profile.name} birthDate={profile.birthDate} onUpdateContext={d => updateTabContext('numerology',d)} birthData={birthData} language={language} /></div>;
      ...
      case 'horoscope': return <div className="animate-fade-up" key={k}><Horoscope sign={userSunSign} onUpdateContext={d => updateTabContext('horoscope',d)} birthData={birthData} language={language} /></div>;
      case 'weekly': return <div className="animate-fade-up" key={k}><WeeklyHoroscope userSign={userSunSign} onUpdateContext={d => updateTabContext('weekly',d)} birthData={birthData} language={language} /></div>;
      case 'monthly': return <div className="animate-fade-up" key={k}><MonthlyHoroscope userSign={userSunSign} onUpdateContext={d => updateTabContext('monthly',d)} birthData={birthData} language={language} /></div>;
      case 'yearly': return <div className="animate-fade-up" key={k}><YearlyPredictions birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} onUpdateContext={d => updateTabContext('yearly',d)} birthData={birthData} language={language} /></div>;
      case 'transits': return <div className="animate-fade-up" key={k}><Transits latitude={location.lat} longitude={location.lng} language={language} /></div>;
      case 'tarot': return <div className="animate-fade-up" key={k}><Tarot onUpdateContext={d => updateTabContext('tarot',d)} birthData={birthData} language={language} /></div>;
      case 'muhurat': return <div className="animate-fade-up" key={k}><Muhurat language={language} /></div>;
      case 'compatibility': return <div className="animate-fade-up" key={k}><Compatibility profile={profile} location={location} language={language} /></div>;
      case 'kundli': return <div className="animate-fade-up" key={k}><KundliMatching profile={profile} location={location} language={language} /></div>;
      case 'remedies': return <div className="animate-fade-up" key={k}><Remedies birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'kpchart': return <div className="animate-fade-up" key={k}><KPChart birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'kpdasha': return <div className="animate-fade-up" key={k}><KPDasha birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} onBack={() => setActiveTab('profile')} language={language} /></div>;
      case 'kphorary': return <div className="animate-fade-up" key={k}><KPHorary language={language} /></div>;
      case 'panchang': return <div className="animate-fade-up" key={k}><Panchang onBack={() => setActiveTab('profile')} language={language} /></div>;
      case 'navamsa': return <div className="animate-fade-up" key={k}><NavamsaChart birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'wealth': return <div className="animate-fade-up" key={k}><WealthPrediction birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'foreign': return <div className="animate-fade-up" key={k}><ForeignSettlement birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'namecorrection': return <div className="animate-fade-up" key={k}><NameCorrection language={language} /></div>;
      case 'timeline': return <div className="animate-fade-up" key={k}><LifeTimeline birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} language={language} /></div>;
      case 'pdfreport': return <div className="animate-fade-up" key={k}><PdfReport birthDate={profile.birthDate} birthTime={profile.birthTime} latitude={location.lat} longitude={location.lng} timezone={profile.timezone} name={profile.name} language={language} /></div>;
      default: return null;
    }
  };
